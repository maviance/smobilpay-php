...
class ObjectSerializer
{
     ...
     * @return string the serialized object
     */
    public static function toQueryValue(mixed $object, ?string $format = null): string
    {
        if (is_array($object)) {
     ...
     */
    public static function toString(string|DateTime $value, ?string $format = null): ?string
    {
