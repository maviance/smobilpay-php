...
class Bill implements ModelInterface, ArrayAccess
{
    ...
    public const BILL_TYPE_REGULAR = 'REGULAR';

    public const BILL_TYPE_OVERDUE = 'OVERDUE';

    public const AMOUNT_TYPE_FIXED = 'FIXED';

    public const AMOUNT_TYPE_CUSTOM = 'CUSTOM';

    public const AMOUNT_TYPE_PARTIAL = 'PARTIAL';

    public const AMOUNT_TYPE_OVERPAY = 'OVERPAY';
     ...
     * Sets penaltyAmount
     *
     * @param float $penaltyAmount Late payment penalty amount in local currency.
     *
     * @return $this
     */
