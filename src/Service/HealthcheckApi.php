...
class HealthcheckApi
{
     ...
     * @return \Maviance\S3PApiClient\Model\Ping
     */
    public function pingGet($xApiVersion)
    {
        list($response) = $this->pingGetWithHttpInfo($xApiVersion);
        return $response;
    }
     ...
     * @throws \Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Maviance\S3PApiClient\Model\Ping, HTTP status code, HTTP response headers (array of strings)
     */
    public function pingGetWithHttpInfo($xApiVersion)
    {
        $returnType = '\Maviance\S3PApiClient\Model\Ping';
        $request = $this->pingGetRequest($xApiVersion);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Maviance\S3PApiClient\Model\Ping',
     ...
     */
    public function pingGetAsync($xApiVersion)
    {
        return $this->pingGetAsyncWithHttpInfo($xApiVersion)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pingGetAsyncWithHttpInfo($xApiVersion)
    {
        $returnType = '\Maviance\S3PApiClient\Model\Ping';
        $request = $this->pingGetRequest($xApiVersion);
