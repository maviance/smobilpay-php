...
class AccountApi
{
     ...
     *
     * @return \Maviance\S3PApiClient\Model\Account
     */
    public function accountGet($xApiVersion)
    {
        [$response] = $this->accountGetWithHttpInfo($xApiVersion);
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Maviance\S3PApiClient\Model\Account, HTTP status code, HTTP response headers (array of strings)
     */
    public function accountGetWithHttpInfo($xApiVersion)
    {
        $returnType = '\Maviance\S3PApiClient\Model\Account';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Maviance\S3PApiClient\Model\Account',
     ...
     */
    public function accountGetAsync($xApiVersion)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountGetAsyncWithHttpInfo($xApiVersion)
    {
        $returnType = '\Maviance\S3PApiClient\Model\Account';
        $request = $this->accountGetRequest($xApiVersion);
     ...
     */
    protected function accountGetRequest($xApiVersion)
    {
